.. rodder documentation master file, created by
   sphinx-quickstart on Sat Dec 19 00:23:01 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to rodder's documentation!
==================================
...
- Install programs
- Easy system to create multiple repos, and add them to user's config files
- Update repos
...
- Issue Tracker: github.com/Ruthenic/rodder/issues
- Source Code: github.com/Ruthenic/rodder
